...
def draw_f1(curve_dict, x_type="f1_diff", scale_free=2):
    ...
    ax.plot(l1_lst, curve_dict[f"hub_ddn_{x_type}"], color="tab:green", label="Hub, DDN")
    ax.plot(l1_lst, curve_dict[f"hub_jgl_{x_type}"], color="tab:green", linestyle='--', label="Hub, JGL")
    ax.plot(l1_lst, curve_dict[f"scale_free_{scale_free}_ddn_{x_type}"], color="tab:red", label="Scale-free, DDN")
    ax.plot(l1_lst, curve_dict[f"scale_free_{scale_free}_jgl_{x_type}"], color="tab:red", linestyle='--', label="Scale-free, JGL")
...
def draw_roc(curve_dict, x_type="fpr_comm", y_type="tpr_comm", scale_free=2):
    ...
    ax.plot(curve_dict[f"hub_ddn_{x_type}"], curve_dict[f"hub_ddn_{y_type}"], color="tab:green", label="Hub, DDN")
    ax.plot(curve_dict[f"hub_jgl_{x_type}"], curve_dict[f"hub_jgl_{y_type}"], color="tab:green", linestyle='--', label="Hub, JGL")
    ax.plot(curve_dict[f"scale_free_{scale_free}_ddn_{x_type}"], curve_dict[f"scale_free_{scale_free}_ddn_{y_type}"], color="tab:red", label="Scale-free, DDN")
    ax.plot(curve_dict[f"scale_free_{scale_free}_jgl_{x_type}"], curve_dict[f"scale_free_{scale_free}_jgl_{y_type}"], color="tab:red", linestyle='--', label="Scale-free, JGL")
...
def draw_f1_feature_num(curve_dict, x_type="f1_diff"):
    ...
    ax.plot(l1_lst, curve_dict[f"scale_free_16_400_ddn_{x_type}"], color="tab:green", label="400 nodes, DDN")
    ax.plot(l1_lst, curve_dict[f"scale_free_16_400_jgl_{x_type}"], color="tab:green", linestyle='--', label="400 nodes, JGL")
    ax.set_xlabel("$\lambda_1$")
    ax.set_ylabel("F1 score")
    fig.legend(loc="outside right center")
    return fig, ax
...
def draw_roc_feature_num(curve_dict, x_type="fpr_comm", y_type="tpr_comm"):
    ...
    ax.plot(curve_dict[f"scale_free_16_400_ddn_{x_type}"], curve_dict[f"scale_free_16_400_ddn_{y_type}"], color="tab:green", label="400 nodes, DDN")
    ax.plot(curve_dict[f"scale_free_16_400_jgl_{x_type}"], curve_dict[f"scale_free_16_400_jgl_{y_type}"], color="tab:green", linestyle='--', label="400 nodes, JGL")
    ax.set_xlim([-0.001,0.02])
    ax.set_xlabel("False positive rate")
    ax.set_ylabel("True positive rate")
    fig.legend(loc="outside right center")
